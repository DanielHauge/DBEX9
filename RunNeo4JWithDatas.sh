...
sudo docker exec -it neo4j sh -c 'neo4j-admin import --nodes:Person import/social_network_nodes.csv --relationships:ENDORSES import/social_network_edges.csv --ignore-missing-nodes=true --ignore-duplicate-nodes=true --id-type=INTEGER'
